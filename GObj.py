...
class GObj:
    ...
    def getX(self): #------------------------------- 7/22 added
        return self.x
    
    def getY(self): #------------------------------- 7/22 added
        return self.y
...
class Square(GObj): #----------------------------- 7/22 add this class
...
class Label(GObj):
    ...
    def setFontSize(self, fontSize): #------------------ 7/22 changed name
        self.fontSize = fontSize
    def getFontSize(self): #------------------------- 7/22 changed name
        return self.fontSize

    def setText(self, message):
        self.message = message
    def getText(self): #------------------ 7/ 22 added
        return self.message
